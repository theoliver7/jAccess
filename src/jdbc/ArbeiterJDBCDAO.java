...
public class ArbeiterJDBCDAO extends Datenbank implements ArbeiterDAO {
	...
	public List<Arbeiter> findTeam(String teamname) throws SQLException {
		...
		String sql = "Select A.Name, A.Nachname, A.kuerzel, A.Wohnort, A.Funktion, ABT.Abteilungsname "
				+ "FROM arbeiter as A INNER JOIN abteilung as ABT on A.AbteilungID = ABT.idAbteilung "
